      ...
      <div className="mx-auto max-w-4xl px-6 py-12 sm:py-20">
        ...
        <article className="mt-12 space-y-10">
          ...
          <section className="space-y-4 leading-relaxed text-muted-foreground">
            ...
            <p>Il sito è riferito a Ramirez Atelier, laboratorio di falegnameria artigiana con sede in Via S. Andrea, Zona Artigianale, Borgagne di Melendugno, 73026.</p>
            ...
            <p><strong className="text-foreground">Prima della pubblicazione definitiva, verificare e completare qui la denominazione giuridica esatta del titolare e gli eventuali dati fiscali.</strong></p>
          </section>
