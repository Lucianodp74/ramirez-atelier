    ...
    <main className="mx-auto max-w-6xl px-6 py-12">
      ...
      <div className="mb-8 mt-2">
        ...
        <p className="mt-2 max-w-3xl text-sm text-muted-foreground">
          I tuoi prezzi interni hanno priorità sui benchmark. Le modifiche al prezzo vengono storicizzate e non cambiano i costi già salvati nelle BOM.
        </p>
      </div>
          ...
          <tbody className="divide-y">
            {righe.map((riga, indice) => {
              ...
              return <tr key={riga.id}>
                ...
                <td className="p-3">{riga.categoria}</td><td className="p-3">{riga.unita}</td><td className="p-3 font-semibold">{euro.format(riga.prezzo)}</td>
